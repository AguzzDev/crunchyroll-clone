...
import { synopsisF, genresMap, studioMap, producersMap, durationTotal, scoredBy, allFavorites } from 'utils/formats'
            ...
            <div className='flex  flex-col-reverse lg:flex-row justify-between lg:space-x-4  p-5 lg:pt-0 lg:pl-0'>
              <div className=' lg:w-9/12'>
                ...
                <div className='py-5'>
                  ...
                  <p className='text-sm text-gray-700'>{synopsisF(synopsis)}</p>
